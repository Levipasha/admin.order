...
export const initialMenus = [
  ...
  },
  {
    ...
    inStock: true,
    addons: [
      { name: "Chia seeds topping", price: 20 }
    ]
  }
];
...
export const subscriptionPlans = [
  ...
  { id: "basic", name: "Premium Pro", price: 999, period: "Month", features: ["Advanced glassmorphic themes", "Realtime order dashboard", "WhatsApp notifications", "Unlimited monthly orders"] }
];
